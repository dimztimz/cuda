...
__global__ void matrixProduct(float * d_mat1, float * d_mat2, float * d_matProd, int red1, int kol1red2, int kol2)
{
...
int main(int argc, char * argv[])
{
	...
	float * h_mat1, * h_mat2, * h_matProd;
	float * d_mat1, * d_mat2, * d_matProd;
	...
	matrixProduct<<<dimGrid, dimBlock>>>(d_mat1, d_mat2, d_matProd, red, kol, red);
	cudaEventRecord(end);
